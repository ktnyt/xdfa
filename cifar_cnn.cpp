...
int main() {
  ...
  Convolution2D conv1_1(32, 3, 1, 0, O::Adam());
  ReLU a1_1;
  Convolution2D conv1_2(32, 3, 1, 0, O::Adam());
  ReLU a1_2;
  MaxPooling2D pool1(2, 2, 0);
  Dropout d1(0.25);

  Convolution2D conv2_1(64, 3, 1, 0, O::Adam());
  ReLU a2_1;
  Convolution2D conv2_2(64, 3, 1, 0, O::Adam());
  ReLU a2_2;
